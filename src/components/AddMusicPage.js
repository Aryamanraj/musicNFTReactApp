...
const SongUploader = () => {
  ...
  return (
    <div>
    <form id="songUploaderForm" className="form-container" onSubmit={handleSubmit}>
      <div>
        <label htmlFor="cover">Cover Image or Video:</label>
        <input type="file" id="cover" name="cover" onChange={handleFileChange} accept="image/*, video/*" />
      </div>
      <div>
        <label htmlFor="title">Title:</label>
        <input type="text" id="title" name="title" value={metadata.title} onChange={handleInputChange} />
      </div>
      <div>
        <label htmlFor="genre">Genre:</label>
        <input type="text" id="genre" name="genre" value={metadata.genre} onChange={handleInputChange} />
      </div>
      <div>
        <label htmlFor="tags">Additional Tags:</label>
        <input type="text" id="tags" name="tags" value={metadata.tags} onChange={handleInputChange} />
      </div>
      <div>
        <label htmlFor="spotifyLink">Spotify Link:</label>
        <input type="text" id="spotifyLink" name="spotifyLink" value={metadata.spotifyLink} onChange={handleInputChange} />
      </div>
      <div>
        <label htmlFor="soundcloudLink">SoundCloud Link:</label>
        <input type="text" id="soundcloudLink" name="soundcloudLink" value={metadata.soundcloudLink} onChange={handleInputChange} />
      </div>
      <div>
        <label htmlFor="youtubeLink">YouTube Link:</label>
        <input type="text" id="youtubeLink" name="youtubeLink" value={metadata.youtubeLink} onChange={handleInputChange} />
      </div>
      <div>
        <label htmlFor="tiktokLink">TikTok Link:</label>
        <input type="text" id="tiktokLink" name="tiktokLink" value={metadata.tiktokLink} onChange={handleInputChange} />
      </div>
      <div>
      <label htmlFor="artistName">Artist Name:</label>
        <input type="text"         id="artistName" name="artistName" value={metadata.artistName} onChange={handleInputChange}
      />
      </div>
      <div>
